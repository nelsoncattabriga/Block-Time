...
last_activity: "2026-06-02 - Split SettingsView.swift into per-category files"
progress:
  total_phases: 1
  completed_phases: 0
  total_plans: 3
...
# Block-Time — Project State

## Status

Active v1.x development. No active phase.
Last updated: 2026-06-02

## Phase Progress

- ☐ Phase 9 — Crew Contact Feature (in progress)
...
| 260523-tux | Fix HH:MM mode input in FieldTimeField and BulkEditTimeField | 2026-05-23 | b4cc346 | [260523-tux-fix-hh-mm-mode-input-in-fieldtimefield-a](./quick/260523-tux-fix-hh-mm-mode-input-in-fieldtimefield-a/) |
...
| 260524-eml | Apply HH:MM input fixes to ModernDecimalTimeField | 2026-05-24 | 6575178 | [260524-eml-apply-hh-mm-input-fixes-to-moderndecimal/](./quick/260524-eml-apply-hh-mm-input-fixes-to-moderndecimal/) |
...
| 260524-hnc | Training Record PDF: dynamic layout, crew cols dropped, user-selectable custom fields | 2026-05-24 | 316569a | [260524-hnc-training-record-pdf-dynamic-layout-dropp](./quick/260524-hnc-training-record-pdf-dynamic-layout-dropp/) |
| 260524-iw3 | Fix cover page rule line to match rendered title width | 2026-05-24 | c260347 | [260524-iw3-fix-cover-page-rule-line-to-match-title-](./quick/260524-iw3-fix-cover-page-rule-line-to-match-title-/) |
| 260524-jai | Fix Flight Info widget stale Tomorrow label | 2026-05-24 | 5105bfd | [260524-jai-fix-widget-flight-info-mode-stale-tomorr](./quick/260524-jai-fix-widget-flight-info-mode-stale-tomorr/) |
| 260524-krm | Add App Store update check to SplashScreenView | 2026-05-24 | c5e9e7b | [260524-krm-add-app-store-update-check-to-splashscre](./quick/260524-krm-add-app-store-update-check-to-splashscre/) |
| 260526-j09 | Fix custom fields code review issues | 2026-05-26 | 79ec901 | [260526-j09-fix-custom-fields-code-review-issues-ale](./quick/260526-j09-fix-custom-fields-code-review-issues-ale/) |
| 260527-ddv | Fix ModernRemarksField label to use uppercased() | 2026-05-27 | ccc8ac8 | [260527-ddv-fix-modernremarksfield-label-to-use-uppe](./quick/260527-ddv-fix-modernremarksfield-label-to-use-uppe/) |
| 260601-a73 | Add Crew Notes management UI to Settings | 2026-06-01 | 54d3628 | [260601-a73-add-crew-notes-management-ui-to-settings](./quick/260601-a73-add-crew-notes-management-ui-to-settings/) |
...
| 260601-rdn | Add undo/redo bar to flights list views | 2026-06-01 | cccb7ad | [260601-rdn-add-undo-redo-bar-to-flights-list-views](./quick/260601-rdn-add-undo-redo-bar-to-flights-list-views/) |
