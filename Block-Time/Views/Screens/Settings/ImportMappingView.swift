...
//                }
    ...
    private static func detectColumns(for logbookField: String, in headers: [String], allowMultiple: Bool) -> [String] {
        ...
        let variations: [String: [String]] = [
            ...
            "aircraftreg": ["reg", "registration", "aircraft", "aircraftreg", "tail", "id", "aircraftregistration"],
            "aircrafttype": ["type", "aircrafttype", "make", "model","make/model"],
            "fromairport": ["from", "departure", "dep", "origin", "detailsdeparture"],
            "toairport": ["to", "arrival", "arr", "destination", "dest", "des", "detailsarrival"],
            "captainname": ["captain", "cpt", "pic", "captainname","PIC/P1 Crew","P1 Crew", "pilotincommand"],
            "f/oname": ["fo", "firstofficer", "copilot", "sic","SIC/P2 Crew","P2 Crew","P2", "crewcopilot"],
            "s/o1name": ["so1", "so", "secondofficer","relief","cruise","P3", "crewcruisecopilot"],
            "s/o2name": ["so2", "secondofficer2","P4", "crewotherpilot"],
            "std": ["std", "scheduleddeparture", "scheduleddep", "scheddep", "etd", "dutystart"],
            "sta": ["sta", "scheduledarrival", "scheduledarr", "schedarr", "eta", "dutyfinish"],
            "outtime": ["out", "outtime", "blockout", "off"],
            "intime": ["in", "intime", "blockin", "on"],
            "blocktime": ["block", "blocktime", "total", "totaltime", "blockduration"],
            "nighttime": ["night", "nighttime", "picnight", "p1night", "sicnight", "p2night", "fonight", "captainnight", "firstofficernight", "sei.c.u.s.night", "sedualnight", "secommandnight", "mei.c.u.s.night", "medualnight", "mecommandnight", "meco-pilotnight"],
            "p1time": ["p1", "p1time", "pictime", "secommandday", "secommandnight", "mecommandday", "mecommandnight"],
            "p1ustime": ["p1us", "icus", "p1u/s", "p1ustime", "icustime", "p1supervisedtime",
                         "sei.c.u.s.day", "sei.c.u.s.night", "mei.c.u.s.day", "mei.c.u.s.night"],
            "p2time": ["p2", "sic", "p2time", "sictime", "firstofficer", "copilot", "copilottime", "relief",
                       "sedualday", "sedualnight", "medualday", "medualnight", "meco-pilotday", "meco-pilotnight"],
            "instrumenttime": ["instrument", "ifr", "inst", "instr", "actualinstrument", "hood", "instrumentinflight"],
            "simtime": ["sim", "simulator","synthetic","cyclic", "instrumentground"],
            "pilotflying": ["pf", "pilotflying", "flying", "handlingrole"],
            "pax": ["pax", "positioning", "deadhead", "passenger"],
            "daytakeoffs": ["daytakeoffs", "dayt/o", "dayto", "takeoffsday", "to_day", "dayt-o"],
            "daylandings": ["daylandings", "dayldg", "landingsday", "ldg_day"],
            "nighttakeoffs": ["nighttakeoffs", "nightt/o", "nightto", "takeoffsnight", "to_night", "nightt-o"],
            "nightlandings": ["nightlandings", "nightldg", "landingsnight", "ldgnight"],
            "rnp": ["rnp", "rnav", "rnp-ar", "rnv", "rnav/rnpapproaches"],
            "ils": ["ils", "cat1","cat2", "ils(cati)approaches"],
            "gls": ["gls"],
            "npa": ["npa", "non-precision(generic)approaches"],
            "aiii": ["aiii","cat3"],
