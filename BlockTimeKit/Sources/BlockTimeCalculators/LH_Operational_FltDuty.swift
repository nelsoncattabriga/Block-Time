...
public enum LH_CrewComplement: String, Codable, CaseIterable {
...
public enum RelevantSectorRole: String, Codable {
...
public enum InboundAUNZContext: String, Codable {
...
public struct DutyLimit: Codable {
    ...
    public init(crewComplement: LH_CrewComplement, restFacility: CrewRestFacility?, dutyPeriodLimitPlanned: Double?, dutyPeriodLimitDiscretion: Double?, flightTimeLimit: Double?, flightTimeLimitNote: String?, requirements: String?) {
...
public struct RestRequirement: Codable {
    public let crewComplement: LH_CrewComplement
    ...
    public init(crewComplement: LH_CrewComplement, direction: RestDirection, dutyPeriodThreshold: String, minimumRestHours: Double?, minimumRestFormula: String?, requirements: String?) {
        self.crewComplement = crewComplement
...
public struct InboundAUNZRest: Codable {
...
public struct TwoPilotConsecutiveDutyNote: Codable {
...
public struct CrewRestAircraftDefinition {
