...
public static let augmentedDutyLimits: [AugmentedDutyLimit] = [
        AugmentedDutyLimit(
...
public static let twoPilotFlightTimeLimits: [FlightTimeLimit] = [
        FlightTimeLimit(
...
public static let augmentedFlightTimeLimitHours: Double = 10.5
...
public static func maxFlightTimeHours(sectorsScheduled: Int, darknessFlightTimeExceeds7Hours: Bool) -> Double {
...
public static func maxDutyHoursAugmented(restFacility: AugmentedRestFacility, sectors: Int, dutyHours: Double) -> Double? {
...
public static let lateNightMaxConsecutiveNights: Int = 4
    /// FD24.2 — once per 28 consecutive days: max late night nights in any 7-night period.
public static let lateNightMaxConsecutiveNightsException: Int = 5
public static let lateNightExceptionPeriodDays: Int = 28
    /// FD24.3(a) — max duty hours in a 7-night period when >2 LNO duties are present.
public static let lateNightMaxDutyHoursIn7NightPeriod: Double = 40
    /// FD24.3(b) — max duty periods in that 7-night period (except per FD24.2).
public static let lateNightMaxDutyPeriodsIn7NightPeriod: Int = 4
    /// FD24.3(c) — min hours free before any non-LNO duty after consecutive late nights.
public static let lateNightRecoveryMinFreeHours: Double = 24
